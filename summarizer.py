...
- 길이: {duration_str} (이 길이를 절대 초과하는 타임스탬프를 사용하지 마)
{transcript_section}
...
⚠️ 타임스탬프 형식 규칙 (매우 중요):
- 반드시 `### [HH:MM:SS]` 형식 사용 (시:분:초)
- 영상 길이가 {duration_str}이므로 이를 절대 초과하지 마
- 예시: 1분 30초 → `### [00:01:30]`, 5분 → `### [00:05:00]`
- 잘못된 예: `### [01:30:00]` (이건 1시간 30분임)
- 장면은 최대 10개 이내로 작성해줘
